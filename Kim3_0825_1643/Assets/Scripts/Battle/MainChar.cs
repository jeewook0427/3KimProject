...
public class MainChar : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            case 0:
                Instantiate(normalPrefab, prefabPos, Quaternion.Euler(prefabRot));
                break;
            case 1:
                Instantiate(tankPrefab, prefabPos, Quaternion.Euler(prefabRot));
                break;
            case 2:
                Instantiate(dpsPrefab, prefabPos, Quaternion.Euler(prefabRot));
                break;
        }
    }
