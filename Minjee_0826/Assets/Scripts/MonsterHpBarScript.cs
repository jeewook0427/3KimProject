...
{ // Visible health bar ui:
    ...
    [Tooltip("Health variable: (default range: 0-100)")] public float health = 1000;
    ...
    [Tooltip("Maximum possible heath: (default is 100)")] public float maximumHealth = 1000;

    // If the character has this health or less, consider them having low health:
    [Tooltip("Low health is less than or equal to this:")] public int lowHealth = 330;
    ...
    [Tooltip("High health is greater than or equal to this:")] public int highHealth = 670;
